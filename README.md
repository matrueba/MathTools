# MathTools AI Development Framework Installer
...
*(This will safely clone the repository to `~/.mathtools`, set up the python virtual environment, and create an executable symlink in `~/.local/bin/matrueba-sdd`).*
